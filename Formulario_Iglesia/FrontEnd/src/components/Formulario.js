    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://localhost:5000/api/requests', {
                ...
                fechaProyeccion,
                ministerioId,
                imagen: '', // Si no tienes imágenes, puedes dejar esto vacío
                video: '',  // Si no tienes videos, puedes dejar esto vacío
                correoMinisterio,
                informacion,
        ...
        <div className="form-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="form-group section-title-info">
                    <h2>Información que debe llevar
                        el video o imagen</h2>
